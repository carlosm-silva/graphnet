...
> **LLM-generated handoff: read critically**
>
> Most of this documentation was generated by OpenAI Codex and ChatGPT through
> multiple drafting, adversarial-review, and auditor rounds under the original
> author's scientific direction. The author reviewed or skimmed substantial
> portions, but did not independently verify every claim. Given the size of the
> handoff, errors, omissions, and contradictions remain possible—and likely.
>
> Treat these pages as a map and evidence trail, not as unquestionable
> authority. Check consequential claims against the source, resolved configs,
> artifacts, and actual runs. Push back, investigate discrepancies, and ask the
> original author or other group members when intent is unclear. Verification
> labels describe the evidence gathered; they do not guarantee correctness.
> Critical questioning is expected scientific practice.
>
> The implementation itself was also developed with substantial Codex and
> ChatGPT assistance. The original author remains willing to help: send him a
> Slack message with questions about history, intent, or physics choices.
